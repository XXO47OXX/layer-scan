"""Custom probe loader — load user-defined probes from JSON/YAML files.

Users can define their own evaluation probes without writing Python code.
"""
...
class CustomProbe(Probe):
    ...
    Expected JSON format:
    {
        ...
        "scoring": "digits",  // "digits" (0-9) or "custom"
        "samples": [
            {
