...
which is critical for production LLM pipelines (e.g., fingerprint extraction).

This probe is unique to layer-scan — it fills a gap where layer duplication
may trade off instruction-following for reasoning (as seen in RYS IFEval -2.05%).
"""
